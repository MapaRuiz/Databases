...
Insert into DETALLEPEDIDOS (CODIGOPEDIDO,CODIGOPRODUCTO,CANTIDAD,PRECIOUNIDAD,NUMEROLINEA) values (15,'OR-203',900000,10,4);
...
SET DEFINE OFF;
INSERT INTO GAMASPRODUCTOS (GAMA, DESCUENTO) VALUES ('Aromáticas', 10);
INSERT INTO GAMASPRODUCTOS (GAMA, DESCUENTO) VALUES ('Frutales', 0);
INSERT INTO GAMASPRODUCTOS (GAMA, DESCUENTO) VALUES ('Herbaceas', 5);
INSERT INTO GAMASPRODUCTOS (GAMA, DESCUENTO) VALUES ('Herramientas', 20);
INSERT INTO GAMASPRODUCTOS (GAMA, DESCUENTO) VALUES ('Ornamentales', 15);
...
Insert into PRODUCTOS (CODIGOPRODUCTO,NOMBRE,GAMA,DIMENSIONES,PROVEEDOR,CANTIDADENSTOCK,PRECIOVENTA,PRECIOPROVEEDOR) values ('OR-150','Bougamvillea roja, naranja','Ornamentales','110-130','Viveros EL OASIS',1000,2,1);
...
Insert into PRODUCTOS (CODIGOPRODUCTO,NOMBRE,GAMA,DIMENSIONES,PROVEEDOR,CANTIDADENSTOCK,PRECIOVENTA,PRECIOPROVEEDOR) values ('OR-251','Zamia Furfuracaea','Ornamentales','90 - 110','Viveros EL OASIS',1500,168,134);
...
--------------------------------------------------------
--  Constraints for Table CLIENTES_LOG
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table PEDIDOS_LOG
--------------------------------------------------------

  ALTER TABLE "PEDIDOS_LOG" ADD CONSTRAINT "PK_PEDIDOS_LOG" PRIMARY KEY ("ID_AUDITORIA")
   USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
   STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
   PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
   BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--- Ref Constrains for Table NOFICACIONES 
--------------------------------------------------------
    ALTER TABLE NOTIFICACIONES ADD CONSTRAINT FK_DESTINATARIO FOREIGN KEY ("DESTINATARIO")
    REFERENCES EMPLEADOS ("CODIGOEMPLEADO") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
    ...
    GRANT ALL ON PEDIDOS_LOG TO JPALACIO;
    GRANT ALL ON CLIENTES_LOG TO JPALACIO;
